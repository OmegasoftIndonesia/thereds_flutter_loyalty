          ...
          child: Container(
            ...
            child: Padding(
              ...
              child: Obx(() {
                return Column(
                  children: [
                    Text("${controller.util.getString(PreferencesUtil.name)}",
                      style: TextStyle(color: Colors.white, fontSize: 15),),
                    Text("${controller.level.value}", style: TextStyle(
                        color: Colors.white,
                        fontSize: 20,
                    ...
                    Row(
                      ...
                      children: [
                        Text("Total Spending", style: TextStyle(color: Colors
                            .white),),
                        Text("${controller.totalSpending.value} Hour",
                    ...
                    RichText(
                        ...
                        text: TextSpan(
                            ...
                            children: [
                              TextSpan(text: "Spend "),
                              TextSpan(text: "${controller.sisaHour.value} Hour ",
                                  style: TextStyle(
                                      fontWeight: FontWeight.bold
                                  )),
                              TextSpan(text: "more to reach "),
                              TextSpan(text: "${controller.Nextlevel.value} ",
                                  style: TextStyle(
                                      fontWeight: FontWeight.bold
                                  )),
                              TextSpan(text: "and you will get "),
                              TextSpan(text: "${NumberFormatter.decimal(int.parse(controller.nextReward
                                  .value))} Points", style: TextStyle(
                                  fontWeight: FontWeight.bold,
